...
void ConsoleDoubleBuffer::Initialize()
{
	...
	SetConsoleCursorInfo(hBuffer[0], &consoleCursor);				// 커서 설정
	...
	SetConsoleCursorInfo(hBuffer[1], &consoleCursor);				// 커서 설정
...
{
	// hBuffer 배열의 요소를 처음부터 끝까지 순서대로 가져와서 루프안에서 사용함
